...
$sql = "SELECT * FROM payment WHERE member_id='".$_SESSION['id']."' and approvestatus='1' ";
	...
	<div style="width: 100%; margin-top: 73px;">
			...
			?>
				<div class="login col-md-4">
					<form method="post" action="" id="lgform1">
						...
						<input type="password" class="form-control" required id="Password" style="font-family: 'Poppins',sans-serif; font-size: 18px;" placeholder="**********">
						<button type="submit" id="lgin" class="btn btn-info" style="margin-top:10px; font-family: 'Poppins', sans-serif; font-size: 19px;">Log in</button>
					</form>
					...
					<button class="btn btn-danger" data-toggle="modal" data-target="#reg" style="font-family: 'Poppins', sans-serif; font-size: 19px;">Register</button>
				</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h3 class="modal-title" id="exampleModalLabel" style="color: #662e91; text-align: center; margin-left: 15px;">Register: </h3>
					...
					<div class="modal-body" style="padding:0px 30px; padding-bottom: 20px;">
						<form id="registration_form" class="" method="post">
							...
							<input type="text" required id="name" class="form-control" name="name33" placeholder="Enter Your Name" autocomplete="off">
							...
							<div id="result"></div>
							<button class="btn btn-info form-control" id="regbtn" style="font-family: 'Poppins'">Register</button>
						</form>
		...
		<div class="modal fade" id="log" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h3 class="modal-title" style="color: #662e91; margin-left: 15px; " id="exampleModalLabel">Log in:</h3>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					<div class="modal-body" style="padding:0px 30px; padding-bottom: 20px;">
						<form id="login" method="post" action="">
							...
							<br>
							<button type="submit" id="logn" class="btn btn-info form-control" style="font-family: 'Poppins'">Log in</button>
						</form>
						<br>
						<div id="resultx">
		...
		?>
		<div class="section2">
			<h1 style="color: #662e91; font-size: 30px;text-align: center;">Smart, reliable, and easy solution for finding a partner
			</h1>
			
			<h5 style="color: #7f7f7f;text-align: center;">Welcome to the country's self-contained online wedding service. The simplest way to find a mate is soulmate.com and not just go behind the wheel, find a partner of your choice. You can also exchange information through your web site. So don't hesitate to register now at soulmate.com and enjoy something new.</h5>
			<?php
			if (isset($_SESSION['user'])/* || isset($_COOKIE['user'])*/) {
			} else {
			...
			?>
				<center><button class="btn btn-danger" style="font-family: 'Poppins', sans-serif; font-size: 19px; margin-bottom: 10px;" data-toggle="modal" data-target="#reg">Register</button></center>
			<?php
			}
			?>
		</div>
	...
	<div class="p_sec3 row">
		...
		<div class="section3 col-md-4" style="background: white; height: inherit; padding: 10px 17px;">
			<h4 style="color: #662e91;">Let's take a look at how to complete Registration and Biodata at Marriage 20:</h4>
			<iframe width="100%" height="270" src="https://www.youtube.com/embed/pydEI2FBaXA">
			</iframe>
		</div>
	</div>
...
" class="row">
			...
			<div class="col-md-4">
				...
				<h6 style="color: #7f7f7f; text-align: center;">Email: manuhelp@gmail.com</h6>
	...
	<!--
	<div class="row" style="background: rgb(237,6,143); /* Old browsers */
...
-->
 ...
 <!--  Project Developed by: Akhil & Anjana. 

<?php
	...
	if(isset($_POST['submit'])){
    	...
    	$mail->Username = "SoulMate@gmail.com";
    	...
    	$mail->Subject = "Reset Password | SoulMate";
    
        $mail->isHTML(true);
    	
    	$mail->Body = "<img src='https://www.soulmate.com/img/mail.png' width='400'>
    	<br>
    	<h2 style='color: #662e91;'>Hi, ".$name."</h2>
    	<h3 style='color: #000;'>To reset your password please follow the link below</h3>
    	<a href='https://soulmate.com/reset_password.php?user=$check&key=$mail_key'><h3>https://soulmate.com/reset_password.php?user=$check&key=$mail_key</h3></a>
    	<h3 style='color: #000;'>Thank you for being with soulmate.com";
    	$mail->setFrom($sendfrom,'SoulMate bd');

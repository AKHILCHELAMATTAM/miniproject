			...
			<div class="b_posts" style="padding-top: 0px; padding-bottom: 1px; ">
				<div class="row" style="background: #f9f9f9; padding: 4px 5px; padding-top: 10px;">
					...
					<div class="col-md-8 f_name">
						<h4 style="padding: 5px;"><a style="text-decoration: none; color: #662e91;" href="profile.php?us1031gdh312k=<?php echo $poster; ?>"><?php echo $name;?></a></h4>
					</div>
			...
			<div style="box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); background: #f2f2f2; margin: 0; padding: 10px 19px;">
				<form method="post" action="" id="comment_form">
					<div class="btn-group" style="width: 100%;">
						...
						<button id="s_comment" type="submit" class="btn btn-light" style="color: #662e91;"><img src="commen.png" width="25"></button>
					</div>
				</form>
			</div>
			<?php
...
?>
			<div class="b_posts" style="padding-top: 0px; padding-bottom: 1px; ">
				<div class="row" style="background: #f9f9f9; padding: 4px 5px; padding-top: 10px;">
					...
					<div class="col-md-8 f_name">
						<h4 style="padding: 5px;"><a href="profile.php?us1031gdh312k=<?php echo $poster; ?>" style="text-decoration: none; color: #662e91;"><?php echo $name;?></a></h4>
					</div>
					<div class="col-md-3 time">
						<h6 style="color: #7f7f7f;"><?php echo $time;?></h6>
						<h6 style="color: #7f7f7f;"><?php echo $date; ?></h6>
			    ...
			    <div class="modal-content" style="padding: 0">
			      ...
			      <div class="modal-body" style="padding:0px 30px; padding-bottom: 20px;">
			       	<form id="registration_form" class="" method="post">
						...
						<div id="result"></div>      
						<button class="btn btn-info form-control" id="regbtn" style="font-family: 'Poppins'">Open an account</button>
					</form>
		...
		<div style="position: absolute;  bottom: 0; width: 100%; height: 10px;">
			<div style="margin-top: 50px;   background-image: url('img/f.png'); background-size: 100% 100%; padding-bottom: 10px; box-shadow: 0 -5px 8px -5px rgba(0,0,0,0.2); ">
				<div style="width: 80%; margin: 0 auto; padding: 10px;" class="row">
					...
					<div class="col-md-4">
						...
						<h6 style="color: #7f7f7f; text-align: center;">Email: SoulMate@gmail.com</h6>
			...
			<div class="row" style=" background: rgb(237,6,143); /* Old 	browsers */background: -moz-linear-gradient(-45deg, rgba(237,6,143,1) 0%, rgba(169,228,247,1) 100%); /* 			FF3.6-15 */background: -webkit-linear-gradient(-45deg, rgba(237,6,143,1) 0%,rgba(169,228,247,1) 100%); /* 		Chrome10-25,Safari5.1-6 */background: linear-gradient(135deg, rgba(237,6,143,1) 0%,rgba(169,228,247,1) 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#0fb4e7', endColorstr='#a9e4f7',GradientType=1 ); /* IE6-9 fallback on horizontal 		gradient */ width: 100%; margin: 0; padding-top: 5px;">
				...
				<div class="col-md-6" style="padding: 10px 10px;">
					<h6 style=" color: white; text-align: center;"><b>&copy Project Developed by Mayuri.K All Right Reserved. <small>Developed by <a href="#"  class="myname"><u>Nikhil Bhalerao</u></a></small></b></h6>
				</div>
			</div>
		</div>
	</div>

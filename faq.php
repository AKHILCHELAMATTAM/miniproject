			...
			<div class="col-md-9">
				<div class="tab-content" id="v-pills-tabContent" style="min-height: 500px; padding: 20px; width: 98%; margin:0 auto;background: white;  border: 0.5px solid #f2f2f2;border-radius: 4px;">
					<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
						...
						<h5 style="color: #000;">To register, we have to register on our website www.soulmate.com with email and user ID and password of 8-12 digits. Then fill in your information and favorite information to find out your mind Male / Female.</h5>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title" id="exampleModalLabel" style="color: #662e91; text-align: center; margin-left: 15px;">Registerঃ </h3>
				...
				<div class="modal-body" style="padding:0px 30px; padding-bottom: 20px;">
					<form id="registration_form" class="" method="post">
						...
						<div id="result"></div>
						<button class="btn btn-info form-control" style="font-family: 'Poppins'">Open an account</button>
					</form>
...
" class="row">
			...
			<div class="col-md-4">
				...
				<h6 style="color: #7f7f7f; text-align: center;">Facebook: <small><a href="https://www.facebook.com/SoulMatebd/">https://www.facebook.com/SoulMatebd/</a></small></h6>

 ...
 <?php }?>
			...
			<div class="col-md-9" style="margin: 0; padding: 0;">
				<?php
					if(isset($_SESSION['user'])){
				?>
				<button type="button" id="post_now" style="font-family: 'Poppins', sans-serif; margin-top: 60px; margin-bottom: -50px; font-weight: bold;" class="btn btn-info form-control">Post</button>
			<?php } ?>
				...
				<div class="b_posts" id="post_area">
        			...
        			<script>
						...
						<br>
						<button type="submit" id="submit_post" class="btn btn-info" style="font-family: 'Poppins', sans-serif;">Post</button>
					</form>
					<div id="result">

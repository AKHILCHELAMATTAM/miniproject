 ...
 $sql = "SELECT * FROM admin WHERE email='" .$unm . "' and password = '". $pass."'";
  ...
  <div class="popup__content">
    ...
    <p>
     ...
     <?php echo "<script>setTimeout(\"location.href = 'index.php';\",2000);</script>"; ?>
    </p>
  </div>
</div>
...
?>
  ...
  height: 100vh;
  width: 100vw; background-image: url('uploadImage/Logo/<?php echo $row_login['background_login_image']; ?>');
 background-color: #cccccc;">
                <div class="row justify-content-center">
                    <div class="col-lg-3">
                        <div class="login-content card">
                            <div class="login-form">
                                <center><img src="uploadImage/Logo/<?php echo $row_login['login_logo'];?>" style="width:70%;"></center><br>
                                <form method="POST">
